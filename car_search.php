    ...
    <section class="advance_search_menu_sectn bgc-thm2 pb0 mt70-992" style="margin-top: 168px;">
        <div class="container">
            <div class="row">
                ...
                <div class="col col-sm-4 col-lg-2">
                    <div class="advance_search_style">
                        <input class="form-control form_control" type="text" placeholder="Max. Price">
                    </div>
                </div>
                <div class="col col-sm-4 col-lg-2">
                    <div class="advance_search_style">
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="breadcrumb_content style2">
                        <h2 class="breadcrumb_title">SHOP THE LATEST CAR LEASE DEALS AT CarCentive</h2>
                        <p class="subtitle">Cars for Sell</p>
                    </div>
                </div>
            </div>
        </div>
